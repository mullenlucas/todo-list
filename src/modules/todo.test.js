...
describe('Add and Remove Task', () => {
  ...
  test("Remove a task", () => {
    document.body.innerHTML =
      "<li id='id1' class='todo-item'><div class='left-li' id='ld1'><input type='checkbox' id='chid1' class='checkbox-item'><p id='p1' class='p-task'>New item</p></div><i class='menu-display fa-solid fa-ellipsis-vertical' id='1'></i></li>";
    const tasksCl = new Tasks();
    remoHtml("1", tasksCl);
